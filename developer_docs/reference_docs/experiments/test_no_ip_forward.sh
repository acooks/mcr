...
# DISABLED: # Enable IP forwarding in relay namespace (needed for Layer 3 routing)
# DISABLED: sudo ip netns exec relay-ns sysctl -w net.ipv4.ip_forward=1 >/dev/null
